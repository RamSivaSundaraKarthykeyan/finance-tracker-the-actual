    ...
    try {
      if (session) {
        ...
        if (result.success) {
          ...
          alert("Failed to save income: " + result.error);
        }
      } else {
  ...
  return (
    <div className="w-full sm:w-auto">
      <button
        ...
        className="bg-green-600 hover:bg-green-700 text-white px-4 md:px-6 py-2 md:py-3 rounded-xl font-bold flex items-center gap-2 transition-all shadow-lg hover:shadow-green-200 active:scale-95 text-sm md:text-base w-full justify-center sm:w-auto"
      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <FaWallet className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-green-500 transition-colors" />
                  <input
                    type="text"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-gray-400 group-focus-within:text-green-500">
                    $
                  </span>
                  <input
                    type="number"
