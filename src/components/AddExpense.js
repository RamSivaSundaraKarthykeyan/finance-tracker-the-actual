      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div className="p-6 md:p-8 bg-card-bg transition-colors duration-300 rounded-2xl">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl md:text-2xl font-bold text-foreground">New Expense Entry</h2>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-input-bg border-2 border-card-border rounded-xl py-3 pl-12 pr-4 focus:bg-card-bg focus:border-red-500 outline-none transition-all placeholder:text-gray-500 text-sm md:text-base text-foreground"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    type="number"
                    placeholder="0.00"
                    className="w-full bg-input-bg border-2 border-card-border rounded-xl py-3 pl-10 pr-4 focus:bg-card-bg focus:border-red-500 outline-none transition-all placeholder:text-gray-500 text-sm md:text-base text-foreground font-bold"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  type="date"
                  className="w-full bg-input-bg border-2 border-card-border rounded-xl py-3 pl-12 pr-4 focus:bg-card-bg focus:border-red-500 outline-none transition-all text-sm md:text-base text-foreground"
                  value={formData.date}
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows="3"
                className="w-full bg-input-bg border-2 border-card-border rounded-xl py-3 px-4 focus:bg-card-bg focus:border-red-500 outline-none transition-all placeholder:text-gray-500 text-sm md:text-base text-foreground"
            ...
            <div className="pt-4 flex flex-col md:flex-row gap-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-[2] bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-xl font-bold transition-all shadow-lg hover:shadow-red-900/20 active:scale-95 disabled:opacity-50 disabled:scale-100 order-1 md:order-2"
              >
